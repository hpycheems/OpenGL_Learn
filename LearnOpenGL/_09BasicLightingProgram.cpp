...
int main() {
	...
	Shader light("LightPosition_v.glsl", "LightPosition_f.glsl");
	Shader object("BasicColor_v.glsl", "BasicColor_f.glsl");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		object.setVec3("lightPos", glm::vec3(1.2f, 1.0f, 1.2f));
		object.setVec3("objectColor", glm::vec3(0.3f, 0.2f, 0.1f));
		object.setVec3("viewPos", camera.Position);
		//object.setVec("objectColor", )
