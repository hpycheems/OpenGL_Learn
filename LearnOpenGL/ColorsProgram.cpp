...
int main() {
	...
	glm::vec3 lightPosition(1.2f, 1.0f, 1.2f);
	Shader Light("Colors_v.glsl", "LightPosition_f.glsl");


	Shader s("Colors_v.glsl", "Colors_f.glsl");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		s.setVec("objectColor", glm::vec3(1.0f, 0.5f, 0.31f));
		s.setVec("lightColor", glm::vec3(1.0f, 1.0f, 1.0f));
		
		glBindVertexArray(VAO);
		glDrawArrays(GL_TRIANGLES, 0, 36);

		//Redering LightObject
		Light.use();
